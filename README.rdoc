...
6. Run "rails s" in the directory of the repository you cloned
7. With a browser go to http://localhost:3000 to see the app
8. Change the code, commit it with git, and push it back to github
9. Send me a pull request when you're done with a change and I can merge it back into the master branch!
